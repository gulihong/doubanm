...
<<<<<<< HEAD
    ...
    getData() {
      jsonp("https://api.douban.com/v2/movie/subject/" + this.num + "/photos?apikey=0b2bdeda43b5688921839c8ecb20399b&start=0&count=100&client=something&udid=dddddddddddddddddddddd", null, (err, data) => {
        if (err) {
          console.error(err);
        } else {
          console.log(data);
